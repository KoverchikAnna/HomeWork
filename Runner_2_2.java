...
public class Runner_2_2 {
    ...
    public static void main (String [] args){
        ...
        if ((x-(x%1000))==0 && (x-(x%100)!=0)&& (x-(x%10)!=0) ) System.out.println("Трехзначное.");
        else System.out.println("Не трехзначное.");

        //определение является ли его последняя цифра семеркой.
        if (x%10==7)System.out.println("Последняя цифра числа 7.");
        else System.out.println("Пояледня цифра числа не равна 7.");
